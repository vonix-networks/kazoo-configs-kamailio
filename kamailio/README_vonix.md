...
##### The following lines in the `local.cfg` file must be updated for Kamailio to function properly.
#####
...
```
####
#### Or use `envsubst` replace envvars in `local.cfg.templace` to generate `local.cfg` 
